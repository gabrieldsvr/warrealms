...
namespace CityBuilderCore
{
    ...
    public class SelectionDialog : DialogBase
    {
        ...
        protected override void Start()
        {
            ...
            BuildingToggle.onValueChanged.AddListener(new UnityEngine.Events.UnityAction<bool>(buildingToggleChanged));
        }
        ...
        public void Activate(object target)
        {
            ...
            if (target is BuildingReference reference)
            {
                ...
                BuildingToggle.SetIsOnWithoutNotify(!reference.Instance.IsSuspended);
            }
            else
            {
        ...
        {
            if (_currentTarget is BuildingReference buildingReference)
            {
                if (value)
